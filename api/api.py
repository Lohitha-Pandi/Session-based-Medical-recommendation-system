...
# Corrected parser initialization
...
class Predict(Resource):
    def post(self):
        ...
        queries = [s['tag'] for s in symptoms]
        
        if len(queries) <= 3:
            return {"error": "Please select more than 4 symptoms for better result"}
...
class DiseaseResource(Resource):
    ...
    def post(self):
        # Corrected way to retrieve arguments
